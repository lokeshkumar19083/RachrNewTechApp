...
public class UpdateNpModel implements Serializable {

    public UpdateNpModel() {
    }
    ...
    public ArrayList<AddREDetailTwo> addREDetail;
    public FormHistoryDataTwo formHistoryData;
    ...
    public ArrayList<AddREDetailTwo> getAddREDetail() {
        return addREDetail;
    }

    public void setAddREDetail(ArrayList<AddREDetailTwo> addREDetail) {
        this.addREDetail = addREDetail;
    }

    public FormHistoryDataTwo getFormHistoryData() {
        return formHistoryData;
    }

    public void setFormHistoryData(FormHistoryDataTwo formHistoryData) {
