...
public class ProjectNpModelTwo implements Serializable {

    public ProjectNpModelTwo() {
    }
    ...
    public ArrayList<AddREDetail> addREDetail;
    ...
    public ArrayList<AddREDetail> getAddREDetail() {
        return addREDetail;
    }

    public void setAddREDetail(ArrayList<AddREDetail> addREDetail) {
