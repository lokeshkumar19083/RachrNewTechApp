...
public class LevelEditAdapter extends RecyclerView.Adapter<LevelEditAdapter.MyViewHolder> {

    private Context context;
    private List<UserRoleDepartmentModel> userRoleDepartmentModels;

    public LevelEditAdapter(Context context, List<UserRoleDepartmentModel> userRoleDepartmentModels) {
    ...
    @NonNull
    @Override
    public LevelEditAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LevelEditAdapter.MyViewHolder holder, int position) {
