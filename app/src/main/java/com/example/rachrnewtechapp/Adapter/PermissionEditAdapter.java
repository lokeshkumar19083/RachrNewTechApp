...
public class PermissionEditAdapter extends RecyclerView.Adapter<PermissionEditAdapter.MyViewHolder> {

    private Context context;
    private List<UserRoleDepartmentModel> userRoleDepartmentModels;


    public PermissionEditAdapter(Context context, List<UserRoleDepartmentModel> userRoleDepartmentModels) {
    ...
    @NonNull
    @Override
    public PermissionEditAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_edtpermissison,parent,false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull PermissionEditAdapter.MyViewHolder holder, int position) {
