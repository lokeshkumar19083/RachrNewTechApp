...
import com.example.rachrnewtechapp.Adapter.LevelEditAdapter;
import com.example.rachrnewtechapp.Adapter.PermissionAdapter;
import com.example.rachrnewtechapp.Adapter.PermissionEditAdapter;
import com.example.rachrnewtechapp.Adapter.WorkFlowAdapter;
import com.example.rachrnewtechapp.Adapter.WorkflowEditAdapter;
...
public class EditRoleActivity extends AppCompatActivity {
    ...
    private LevelEditAdapter levelEditAdapter;
    private PermissionEditAdapter permissionEditAdapter;
    private WorkflowEditAdapter workflowEditAdapter;
    private PermissionAdapter permissionAdapter;
    private WorkFlowAdapter workFlowAdapter;
    private UserRoleDepartmentModel userRoleDepartmentModel;
    private TextView txt_create_new_user;
    ...
    public class GetDataById extends AsyncTask<Void,Void,List<UserRoleDepartmentModel>> {
        ...
        protected void onPostExecute(List<UserRoleDepartmentModel> departmentFormReceiverModels) {
            ...
            recyclerview_level.setVisibility(View.VISIBLE);
            recyclerview_permission.setVisibility(View.GONE);
            recyclerviewLayout = new LinearLayoutManager(EditRoleActivity.this);
            recyclerview_level.setLayoutManager(recyclerviewLayout);
            levelEditAdapter = new LevelEditAdapter(getApplicationContext(),getUserRoleDepartmentModel);
            recyclerview_level.setAdapter(levelEditAdapter);
            levelEditAdapter.notifyDataSetChanged();
            ...
            ll_permission.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    recyclerviewlayout_one = new LinearLayoutManager(EditRoleActivity.this);
                    recyclerview_permission.setLayoutManager(recyclerviewlayout_one);
                    permissionEditAdapter = new PermissionEditAdapter(getApplicationContext(),getUserRoleDepartmentModel);
                    recyclerview_permission.setAdapter(permissionEditAdapter);
                    permissionEditAdapter.notifyDataSetChanged();
                }
            });
            ...
            ll_wf.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ll_level_layout.setVisibility(View.GONE);
                    ll_permission_layout.setVisibility(View.GONE);
                    recyclerview_two = new LinearLayoutManager(EditRoleActivity.this);
                    recyclerview_workflow.setLayoutManager(recyclerview_two);
                    workflowEditAdapter = new WorkflowEditAdapter(getApplicationContext(),getUserRoleDepartmentModel);
                    recyclerview_workflow.setAdapter(workflowEditAdapter);
                    workflowEditAdapter.notifyDataSetChanged();
                }
            });
